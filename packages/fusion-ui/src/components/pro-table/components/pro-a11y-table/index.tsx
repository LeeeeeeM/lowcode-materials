...
interface AllyTableProps {
  extra: {
    currentPage?: number;
    total?: number;
    setCurrentPageCallback?: (v: number, ...rest: any[]) => void;
    dataSource: any[];
    enableA11yMode: boolean;
  }
}

export const ProA11yTable: React.FC<ProTableProps & AllyTableProps> = (props) => {
                ...
                >
                  <div className="fusion-ui-pro-table-body">
                    ...
                    <div className="fusion-ui-pro-table-content">
                      ...
                      <ProTableBase {...{
                        ...props,
                        dataSource: enableA11yMode ? dataSource : props.dataSource
                      }} loading={loading}>
                        {slots.table}
                      </ProTableBase>
                      {slots.tableAfter}
                  ...
                  {paginationProps && !paginationProps.hidden && (
                    <Pagination
                      ...
                      {
                        ...(enableA11yMode ? {
                          onChange(v: number, ...rest: any[]) {
                            setCurrentPageCallback(v, ...rest);
                            paginationProps?.onChange?.(v, ...rest);
                          }
                        } : {})
                      }
                      popupProps={{

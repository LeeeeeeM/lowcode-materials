...
export class ListSetter extends Component<ArraySetterProps, ArraySetterState> {
  ...
  render() {
    const { hideDescription, extraProps = {}, itemMaxLength, columns, value } = this.props;
...
class ArrayItem extends Component<{
  ...
  render() {
    const { onRemove, field, rawValue } = this.props;
    const { deletable = true } = rawValue || {};
    return (
      <div
      ...
      >
        ...
        <div className="lc-listitem-actions">
          {
            deletable ? <Button size="small" ghost="light" onClick={onRemove} className="lc-listitem-action">
